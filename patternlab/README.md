...
* [Use npm](#use-npm)
* [Download and extract this package in your project](https://github.com/pattern-lab/edition-node-gulp/releases/download/v1.4.0/edition-node-gulp-1.4.0.zip)
* Install Node on your machine
* Install gulp globally by running the following
```
npm install gulp -g

```
* Install gulp-cli globally by running the following
```
npm install gulp-cli@1.2.2 -g

```
* Run npm install to install all dependencies
* if error run this update command to update Patternlab-node
